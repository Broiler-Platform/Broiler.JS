...
Broiler.JS contains substantial AI-assisted implementation. This record exists so that a
...
- **Scope:** The JavaScript parser, compiler, runtime, built-ins, CLR integration, modules, debugging, storage, networking, and integration assemblies.
...
- [ ] Build and automated tests completed; minimum expected commands: `dotnet test Broiler.JS.slnx` plus the documented test262 workflow.
