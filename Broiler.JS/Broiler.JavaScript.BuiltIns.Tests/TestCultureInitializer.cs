...
//     CultureInfo.CurrentCulture (JSIntl: empty invariant name → "en-US"), so `(12345).toLocaleString()`
//     would group as "12.345" under de-DE / tr-TR instead of the expected "12,345".
