...
| `gap-673-finally-override` | `test/language/statements/try/S12.14_A9_T2`, `A10_T2`, `A11_T2`, `A12_T2` (see [triage](triage-issue-673.md#category-4--finally-abrupt-completion-must-override-a-pending-throw-high-confidence)) | New parser/runtime regression: `continue`/`break`/`return` in `finally` discards a pending throw | `Broiler.JS/Broiler.JavaScript.ExpressionCompiler/Generator/ILCodeGenerator.VisitTryCatchFinally.cs`, `Broiler.JS/Broiler.JavaScript.ExpressionCompiler/Core/ILTryBlock.cs` |
...
| `gap-675-missing-builtins` | Issue #675 Problems 8–10 — `test/built-ins/Set/prototype/{add,clear,forEach}/*`, `test/intl402/PluralRules/prototype/select/*`, `test/built-ins/Promise/withResolvers/*` (see [triage](triage-issue-675.md#problems-8-10--new-missing-or-incorrect-built-ins-fixed)) — **fixed** | `Broiler.JS/Broiler.JavaScript.Integration.Tests/Issue675Tests.cs` | `Broiler.JS/Broiler.JavaScript.BuiltIns/Set/JSSet.cs`, `Broiler.JS/Broiler.JavaScript.BuiltIns/Set/JSWeakSet.cs`, `Broiler.JS/Broiler.JavaScript.BuiltIns/Intl/JSIntl.cs`, `Broiler.JS/Broiler.JavaScript.BuiltIns/Promise/JSPromiseStatic.cs` (done) |
| `gap-675-overlap-673` | Issue #675 Problems 1–7 reproduce issue #673's categories (see [triage](triage-issue-675.md#problems-1-7--carried-over-from-issue-673)). `delegating-yield-*` (P1) fixed; the rest map to the open `gap-673-*` batches above. | `Broiler.JS/Broiler.JavaScript.Integration.Tests/Issue673Tests.cs` | see the `gap-673-*` rows above |
